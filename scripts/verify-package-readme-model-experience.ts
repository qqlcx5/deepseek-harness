...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/knowledge/knowledge': { kind: 'none', reason: 'Registry over the storage domain; claims are cross-session data that never enter prompt, tool schema, or session event, and a consumer surfacing a claim owns its own model experience.' },
