...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  GoalChanged: 'goal.md',
  CreateObjectiveRequest: 'objective.md',
  ObjectiveChanged: 'objective.md',
  ObjectiveId: 'objective.md',
  ObjectiveMemberMeta: 'objective.md',
  ObjectiveView: 'objective.md',
  UpdateObjectiveRequest: 'objective.md',
  CreateDecisionRequest: 'decision.md',
  DecisionChanged: 'decision.md',
  DecisionId: 'decision.md',
  DecisionOption: 'decision.md',
  DecisionReview: 'decision.md',
  DecisionView: 'decision.md',
  UpdateDecisionRequest: 'decision.md',
  Reversibility: 'decision.md',
  ClaimChanged: 'knowledge.md',
  ClaimEdge: 'knowledge.md',
  ClaimEdgeRelation: 'knowledge.md',
  ClaimId: 'knowledge.md',
  ClaimSourceKind: 'knowledge.md',
  ClaimView: 'knowledge.md',
  CreateClaimRequest: 'knowledge.md',
  GoalRef: 'goal.md',
  GoalView: 'goal.md',
