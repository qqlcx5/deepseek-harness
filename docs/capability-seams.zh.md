...
flowchart LR
  ...
  pkg_decision_drafter["decision-drafter"]
  ...
  pkg_objective_synthesizer["objective-synthesizer"]
  pkg_e2b["e2b"]
  ...
  svc_decisions --> pkg_command_decision
  svc_decisions --> pkg_decision_drafter
  ...
  svc_objectives --> pkg_objective_synthesizer
