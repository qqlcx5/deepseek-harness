...
<a id="deepseek-aidsh-decision-drafter"></a>

## `@deepseek-ai/dsh-decision-drafter`

需要：`commands` · `decisions` · `objectives` · `sessionQuery` · `subagents`
...
来源：[`packages/decision/decision-drafter/src/index.ts:30`](../packages/decision/decision-drafter/src/index.ts)
...
来源：[`packages/objective/objective-synthesizer/src/index.ts:26`](../packages/objective/objective-synthesizer/src/index.ts)
...
- `@deepseek-ai/dsh-command-decision` — 需要 `commands` · `decisions`（[`packages/decision/command-decision/src/index.ts`](../packages/decision/command-decision/src/index.ts)）
- `@deepseek-ai/dsh-command-feedback` — 需要 `commands`（[`packages/feedback/command-feedback/src/index.ts`](../packages/feedback/command-feedback/src/index.ts)）
- `@deepseek-ai/dsh-command-goal` — 需要 `commands` · `goals`（[`packages/goal/command-goal/src/index.ts`](../packages/goal/command-goal/src/index.ts)）
- `@deepseek-ai/dsh-commands`（[`packages/interaction/commands/src/index.ts`](../packages/interaction/commands/src/index.ts)）
- `@deepseek-ai/dsh-cordis-client-runner`（[`packages/extensions/cordis-client-runner/src/index.ts`](../packages/extensions/cordis-client-runner/src/index.ts)）
- `@deepseek-ai/dsh-decision` — 需要 `storageDomain`（[`packages/decision/decision/src/index.ts`](../packages/decision/decision/src/index.ts)）
...
- `@deepseek-ai/dsh-knowledge` — 需要 `storageDomain`（[`packages/knowledge/knowledge/src/index.ts`](../packages/knowledge/knowledge/src/index.ts)）
- `@deepseek-ai/dsh-llm`（[`packages/llm/llm/src/index.ts`](../packages/llm/llm/src/index.ts)）
- `@deepseek-ai/dsh-lsp`（[`packages/lsp/lsp/src/index.ts`](../packages/lsp/lsp/src/index.ts)）
- `@deepseek-ai/dsh-objective` — 需要 `storageDomain`（[`packages/objective/objective/src/index.ts`](../packages/objective/objective/src/index.ts)）
...
- `@deepseek-ai/dsh-tool-objective` — 需要 `agents` · `objectives` · `tools` · `systemPrompt`（[`packages/objective/tool-objective/src/index.ts`](../packages/objective/tool-objective/src/index.ts)）
