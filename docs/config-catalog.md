...
Source: [`packages/objective/command-objective/src/index.ts:16`](../packages/objective/command-objective/src/index.ts)
...
Requires: `commands` · `decisions` · `objectives` · `sessionQuery` · `subagents`
...
Source: [`packages/decision/decision-drafter/src/index.ts:30`](../packages/decision/decision-drafter/src/index.ts)
...
- `@deepseek-ai/dsh-command-decision` — requires `commands` · `decisions` ([`packages/decision/command-decision/src/index.ts`](../packages/decision/command-decision/src/index.ts))
- `@deepseek-ai/dsh-command-feedback` — requires `commands` ([`packages/feedback/command-feedback/src/index.ts`](../packages/feedback/command-feedback/src/index.ts))
- `@deepseek-ai/dsh-command-goal` — requires `commands` · `goals` ([`packages/goal/command-goal/src/index.ts`](../packages/goal/command-goal/src/index.ts))
- `@deepseek-ai/dsh-commands` ([`packages/interaction/commands/src/index.ts`](../packages/interaction/commands/src/index.ts))
- `@deepseek-ai/dsh-cordis-client-runner` ([`packages/extensions/cordis-client-runner/src/index.ts`](../packages/extensions/cordis-client-runner/src/index.ts))
- `@deepseek-ai/dsh-decision` — requires `storageDomain` ([`packages/decision/decision/src/index.ts`](../packages/decision/decision/src/index.ts))
...
- `@deepseek-ai/dsh-knowledge` — requires `storageDomain` ([`packages/knowledge/knowledge/src/index.ts`](../packages/knowledge/knowledge/src/index.ts))
- `@deepseek-ai/dsh-llm` ([`packages/llm/llm/src/index.ts`](../packages/llm/llm/src/index.ts))
- `@deepseek-ai/dsh-lsp` ([`packages/lsp/lsp/src/index.ts`](../packages/lsp/lsp/src/index.ts))
- `@deepseek-ai/dsh-objective` — requires `storageDomain` ([`packages/objective/objective/src/index.ts`](../packages/objective/objective/src/index.ts))
...
- `@deepseek-ai/dsh-tool-objective` — requires `agents` · `objectives` · `tools` · `systemPrompt` ([`packages/objective/tool-objective/src/index.ts`](../packages/objective/tool-objective/src/index.ts))
