...
- **Calibration is storage only** — the long-horizon calibration report (per the Agent Note, reported after at least 100 reviews) has no consumer yet; `reviewsOf` is the raw trail.
